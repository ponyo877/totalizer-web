...
const Button: FC<buttonOption> = (op: buttonOption) => {
    ...
    return (
        <label
            className={`flex items-center ${op.center && 'justify-center'} h-20 w-64 min-w-2/3 px-6 m-4 text-3xl duration-150 ${bgColor} ${txtColor} rounded-2xl shadow-lg font-Andika cursor-pointer`}
            onClick={op.onClick}>
